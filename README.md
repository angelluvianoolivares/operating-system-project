...
SJF (Shortest Job First) - Non-preemptive, optimizes for throughput.

SRTF (Shortest Remaining Time First) - Preemptive version of SJF, offering the lowest average waiting time.
